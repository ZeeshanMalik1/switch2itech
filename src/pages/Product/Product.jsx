...
<<<<<<< HEAD
          ...
          <div className="w-full md:w-auto flex flex-wrap md:flex-nowrap items-center gap-2 sm:gap-3">
            {role === "admin" && (
              <Link
                to="/admin/products"
                className="h-10 px-3 sm:px-4 font-bold rounded-xl border border-primary/30 text-primary bg-primary/5 hover:bg-primary/10 flex items-center gap-2 text-xs sm:text-sm transition-colors whitespace-nowrap"
              >
                Manage Products
              </Link>
            )}
